      ...
      <View style={styles.content}>
        ...
        <View style={styles.statsContainer}>
          ...
          >
            ...
            <View style={styles.statItem}>
              <Text style={styles.statLabel}>Tracked Hours</Text>
              <Text style={styles.statValue}>{data.length || 24}</Text>
            </View>
          </LinearGradient>
        </View>
        ...
        <View style={styles.messageContainer}>
          ...
          <Text style={styles.messageText}>
            View your usage patterns throughout the day and identify peak consumption hours
          </Text>
        </View>
