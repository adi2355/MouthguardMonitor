...
export const dbEvents = {
  ...
  MOTION_DATA_CHANGED: 'motionDataChanged',
  FSR_DATA_CHANGED: 'fsrDataChanged',
  HRM_DATA_CHANGED: 'hrmDataChanged',
  HTM_DATA_CHANGED: 'htmDataChanged',
  IMPACT_EVENT_RECORDED: 'impactEventRecorded',
